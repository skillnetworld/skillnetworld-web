        ...
        <main className="bg-white min-h-screen text-slate-900 selection:bg-red-500/30">
            ...
            <section className="pt-32 pb-16 bg-slate-50 border-b border-slate-200">
                <div className="container mx-auto px-6 text-center">
                    ...
                    >
                        Mentorship <span className="text-red-600">Program</span>
                    </motion.h1>
                    <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                        Get guided by industry experts and accelerate your career growth.
                    </p>
                </div>
            </section>
            ...
            <section className="py-20 container mx-auto px-6 text-center">
                <div className="max-w-3xl mx-auto p-12 bg-slate-50 rounded-2xl border border-slate-200">
                    ...
                    <p className="text-slate-600">We are currently curating our mentorship program. Check back shortly!</p>
                </div>
            </section>
            <Footer />
        </main>
