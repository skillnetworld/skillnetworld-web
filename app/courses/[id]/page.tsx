...
export default function CourseDetail({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <main className="bg-slate-950 min-h-screen text-white">
            ...
            <section className="pt-32 pb-16 bg-gradient-to-b from-slate-900 to-slate-950 border-b border-slate-800">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-6 mb-8 text-sm">
                            <span className="flex items-center gap-2 text-yellow-500">
                                <FaStar size={18} /> <span className="text-white font-bold">{course.rating}</span>
                            </span>
                        ...
                        <div className="flex items-center gap-4">
                            <Button variant="primary" size="lg">Enroll Now - {course.price}</Button>
                            <span className="text-slate-500 text-sm">30-Day Money-Back Guarantee</span>
                        </div>
                    </div>

                    <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-2xl shadow-blue-500/20 border border-slate-800">
                        <Image
                            src={course.image}
                            alt={course.title}
                            fill
                    ...
                    <div className="mt-12">
                        ...
                        <div className="flex items-center gap-6 bg-slate-900 p-6 rounded-2xl border border-slate-800">
                            ...
                            <div>
                                ...
                                <p className="text-slate-400">Expert Instructor & Mentor</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div className="bg-slate-900 rounded-2xl p-6 border border-slate-800 sticky top-24">
                        ...
                        <ul className="space-y-4 mb-8">
                            <li className="flex justify-between text-slate-400 border-b border-slate-800 pb-2">
                                <span>Duration</span>
                            ...
                            <li className="flex justify-between text-slate-400 border-b border-slate-800 pb-2">
                                ...
                                <span className="text-white">Beginner to Pro</span>
                            </li>
                            <li className="flex justify-between text-slate-400 border-b border-slate-800 pb-2">
                        ...
                        <Button variant="gradient" className="w-full mb-4">Enroll Now</Button>
